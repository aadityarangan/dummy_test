...
/*************************************** Macro Definitions ***************************************/
#define SPI_CHIP_SELECT P7.0
#define ENABLE_SPI_CHIP_SELECT_STRETCH Spi.ChipSelectStretch = 1U
#define DISABLE_SPI_CHIP_SELECT_STRETCH Spi.ChipSelectStretch = 0U
