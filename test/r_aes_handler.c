...
static void XorWithIv(unsigned char* buf, unsigned char* Iv)
{
  unsigned char i;
...
/******************************************************************************
* Function Name : Find_Number_Of_Modules_Location
* Description   : 
* Argument      : struct serial *destinationserial
...
void Get_Random_Iv(unsigned char *iv_buffer, unsigned short rand_seed)
{
	...
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 2, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 4, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 6, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 8, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 10, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 12, &temp_rand, 2);
	temp_rand = (unsigned long)rand();
	memcpy(iv_buffer + 14, &temp_rand, 2);
}

/******************************************************************************
* Function Name : AES_CBC_encrypt
* Description   : 
* Argument      : volatile struct serial *sourceserial
* Return Value  : none
******************************************************************************/
